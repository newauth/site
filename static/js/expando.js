...
class Expando {
  constructor (el) {
	...
	this._el = el; 
    this._elInner = el.querySelector('.js-expando-inner');
    this._elInnerInverter = el.querySelector('.js-expando-inner-inverter');
   ...
   // this._collapseBtn = this._el.querySelector('.js-expando-collapse-btn');
    this._content = el.querySelector('.js-content');
